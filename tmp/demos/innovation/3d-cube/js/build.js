"undefined" == typeof jwplayer && (jwplayer = function(f) {
        ...
        j.pick = function(a) {
            var j = {}, g = e.apply(c, d.call(arguments, 1));
            t(g, function(g) {
                g in a && (j[g] = a[g])
            });
            return j
        ...
        d.repo = function() {
            var a = "//p.jwpcdn.com/" + f.version.split(/\W/).splice(0, 2).join("/") + "/";
            try {
                d.isHTTPS() && (a = a.replace("//", "https://ssl."))
            } catch (b) {}
            return a
        };
    ...
    function(f) {
        ...
        (f.embed.config = function(b) {
            var e = {
                ...
                primary: "html5",
                width: 480,
                base: b.base ? b.base : d.getScriptPath("cube.js"),
                aspectratio: ""
            };
            b = d.extend({}, e, f.defaults, b);
            var e = {
                type: "html5",
                src: b.base + "cube.html5.js"
            },
                k = {
                    type: "flash",
                    src: b.base + "cube.flash.swf"
                };
        ...
        f.embed.download = function(d, e, b) {
            ...
            if (j &&
                ...
                a ? (b = a, d && (a = f("a", "display", d), f("div", "icon", a), f("div", "logo", a), b && a.setAttribute("href", c.getAbsolutePath(b))), b = "#" + d.id + " .jwdownload", d.style.width = "", d.style.height = "", k(b + "display", {
                    ...
                    l ? (e = l, d = f("iframe", "", d), d.src = "//www.youtube.com/embed/" + c.youTubeID(e), d.width = g, d.height = m, d.style.border = "none") : b()
            }
        }
    }(jwplayer), function(f) {
        var c = f.utils,
        ...
        var p = f.cast,
            l = f.utils,
            j = f._,
            t = window.chrome || {}, v, r = {}, q = {}, u, w, x = l.getAbsolutePath(window.location.href),
            y;
